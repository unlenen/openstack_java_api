...
public class IdentityService extends CommonService {
    ...
    @Call(type = HttpMethod.POST, url = "/auth/tokens", headers = {
            @Header(key = "Content-Type", value = "application/json") }, bodyFile = "payloads/identity/token_with_pass.json", statusCode = HttpStatus.CREATED, openstackResult = LoginResult.class)
    ...
    public TokenResult getToken(String authToken, String subjectToken) throws Exception {
        return getTokenInformation(authToken, subjectToken);
    }

    @Call(type = HttpMethod.GET, url = "/auth/catalog", statusCode = HttpStatus.OK, openstackResult = CategoryResult.class)
    ...
    @Call(type = HttpMethod.GET, url = "/domains", statusCode = HttpStatus.OK, openstackResult = DomainResult.class)
    ...
    @Call(type = HttpMethod.POST, url = "/domains", headers = {
            @Header(key = "Content-Type", value = "application/json") }, bodyFile = "payloads/identity/domain_create.json", statusCode = HttpStatus.CREATED, openstackResult = DomainCreateResult.class)
    ...
    @Call(type = HttpMethod.PATCH, url = "/domains/{domain_id}", bodyFile = "payloads/identity/domain_update.json", statusCode = HttpStatus.OK, openstackResult = DomainCreateResult.class)
    ...
    @Call(type = HttpMethod.DELETE, url = "/domains/{domain_id}", statusCode = HttpStatus.NO_CONTENT)
    ...
    @Call(type = HttpMethod.GET, url = "/projects", statusCode = HttpStatus.OK, openstackResult = ProjectResult.class)
    ...
    @Call(type = HttpMethod.POST, url = "/projects", headers = {
            @Header(key = "Content-Type", value = "application/json") }, bodyFile = "payloads/identity/project_create.json", statusCode = HttpStatus.CREATED, openstackResult = ProjectCreateResult.class)
    public ProjectCreateResult createProject(String token, String name, String description, String domainId)
            throws Exception {
    ...
    @Call(type = HttpMethod.DELETE, url = "/projects/{project_id}", statusCode = HttpStatus.NO_CONTENT)
    ...
    @Call(type = HttpMethod.GET, url = "/users", statusCode = HttpStatus.OK, openstackResult = UserResult.class)
    ...
    @Call(type = HttpMethod.POST, url = "/users", headers = {
            @Header(key = "Content-Type", value = "application/json") }, bodyFile = "payloads/identity/user_create.json", statusCode = HttpStatus.CREATED, openstackResult = UserCreateResult.class)
    public UserCreateResult createUser(String token, String username, String password, String email, String description,
    ...
    @Call(type = HttpMethod.DELETE, url = "/users/{user_id}", statusCode = HttpStatus.NO_CONTENT)
    ...
    @Call(type = HttpMethod.GET, url = "/roles", statusCode = HttpStatus.OK, openstackResult = RoleResult.class)
    ...
    @Call(type = HttpMethod.PUT, url = "/domains/{DOMAIN_ID}/users/{USER_ID}/roles/{ROLE_ID}", statusCode = HttpStatus.NO_CONTENT)
    ...
    @Call(type = HttpMethod.PUT, url = "/projects/{PROJECT_ID}/users/{USER_ID}/roles/{ROLE_ID}", statusCode = HttpStatus.NO_CONTENT)
